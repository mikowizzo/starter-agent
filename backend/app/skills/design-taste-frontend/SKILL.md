...
description: >
  Anti-slop frontend skill for landing pages, portfolios, and redesigns. The
  agent reads the brief, infers the right design direction, and ships
...
* **NO vertical rotated text** ("INDEX OF WORK, 2018 - 2026" rotated 90deg). Agency-portfolio cliche. Use it only when the brief is explicitly agency / Awwards / experimental AND it serves a real composition purpose.
...
* **Banned in en-dash form too (`--`) when used as a separator.** Date ranges (`2018-2026`) use a hyphen. Number ranges (`EUR 40-80k`) use a hyphen.
...
npm install --save @primer/react-brand
